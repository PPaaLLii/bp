...
\abstrakt{
\noindent Hlavným cieľom našej bakalárskej práce je navrhnúť spôsob monitorovania informačného systému za účelom zbierania užitočných informácií ohľadom výkonu systému a používateľských preferenciách. Zaoberáme sa najmä otázkami aké informácie zbierať a akými nástrojmi ich zbierať. Existuje viacero nástrojov z časti riešiacich našu problematiku. Zameriame sa na open-source nástroje. V práci si rozoberieme tie najpoužívanejšie, ich výhody, nevýhody a vybrané nástroje integrujeme do akademického informačného systému AiS2. Pomocou nich sa pokúsime zbierať a zobrazovať metriky, ktoré nám pomôžu identifikovať problémy a funkcie, ktoré je potreba vylepšiť.
~\\
~\\
...
Analyzovali sme možnosti monitorovania za účelom optimalizácie interakcie s používateľom systému.
...
%\bibitem{1} Ipsum, L.: Lorem ipsum dolor sit amet.
	...
	\bibitem{1} Wikipedia: the free encyclopedia [online]. San Francisco (CA): Wikimedia Foundation, 2001- [cit. 2015-05-18]. Dostupné z: http://en.wikipedia.org/wiki/Information\_system
	\bibitem{2}  Webová aplikácia. Wikipedia: the free encyclopedia [online]. San Francisco (CA): Wikimedia Foundation, 2001- [cit. 2015-05-18]. Dostupné z: http://sk.wikipedia.org/wiki/Webov\%C3\%A1\_aplik\%C3\%A1cia
	...
	\bibitem{6} ALLSPAW, John a Jesse ROBBINS. Web operations. 1st ed. Sebastopol, CA: O'Reilly, c2010, xvii, 315 p. ISBN 1449377440.
\end{thebibliography}
%
\newpage
