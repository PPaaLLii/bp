...
Neaktuálne metriky nám poskytnú možno už~nep\-ravdivé dáta a preto by metriky mali byť aktuálne. 
...
% TODO su castou skreslenej virtualizacie, spomenut cloud - nie je len problem aisu
...
% TODO dorobyt priklad na realtime
...
% porovnat vzhladom na systemova metriky 
...
\subsection{Dlhodobé monitorovanie systému s použitím logovania}
% TODO zrusit logstash, session, rrd, 
...
Oba nástroje sú odlišné z hľadiska integrácie a architektúry.
...
% TODO cez siet
Statsd klient na rozdiel od Metrics posiela získane metriky cez sieťovú komunikáciu na otvorený UDP port na oddelený statsd server, ktorý ich prijíma, akumuluje a v nastavených časových intervaloch odosiela do ďalších nástrojov. 
...
% TODO preformulovat
Záleží od veľkosti, komplexnosti systému a od požadovanej funkcionality, ktorý nástroj si vyberieme.
...
Jeho nevýhodou je, že sa má komplikovanú inštaláciu.
% TODO dopisat komplikacie
...
Na obrázku 3 môžete vidieť používateľské rozhranie nástroja Zabbix.
...
%TODO aj ked existuju templates pouzitie v AiŚe
...
Architektúra pomocou unicastu je popísaná na obrázku 4.
...
%TODO pridat multicast obrazok

Ganglia priamo nepodporuje detekciu problémov so systémom.
...
Na ukladanie metrík používa RRD databázu, takže metriky nemusíme v Ganglii konfigurovať.
Výhodné je aj jednoduché prepojenie s nástrojom Naggios.
% TODO multicast, 44 web operations poznamka pod ciarov

\subsubsection{Nevýhody nástroja Ganglia}

% TODO nevyuzitie pre dlhodobe,  redhat nevieme deploynut, alert s naggios
...
%logstash, logy obe problemy nejdu jednym nastrojom...uz su logy, session
