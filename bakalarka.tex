...
Vytvorené JSP stránky môžete vidieť v prílohách A - F.

Vo virtuálnom stroji sme si nainštalovali nástroj Statsd server, Graphite, Zabbix a Gangliu.
Po kliknutí na tlačidlo „Special Feature“ sa zavolá príslušná JSP stránka s názvom „sender“, ktorá má inštanciu Statsd klienta (príloha B a D), alebo integrovanú knižnicu Metrics (príloha F), ktoré odošlú metriku o spustení tlačidla a rozlíšenia obrazovky používateľa do príslušného nástroja na uloženie a zobrazenie metriky.
...
%\lstinputlisting{statsd-graphite.jsp}
