\documentclass[a4paper, usesections, upjsfrontpage, thesismargins, thesislinespacing, twoside]{rnthesis}
...
% disablespecwarning, {rnthesissvk}
...
Gangliu sa nám však nepodarilo nasadiť na najnovšiu verziu CentOS distribúcie, pretože Ganglia ešte nie je pre túto verziu dostupná.
Vybrali sme si teda nástroj Zabbix, ktorý má vďaka používaniu MySQL databázy veľký potenciál okrem zbierania metrík v reálnom čase zbierať aj metriky dlhodobo za účelom hĺbkovej analýzy. 

Zabbix sme teda nasadili na testovacie, vývojové a ostré prostredie do akademického informačného systému AiS2.
Určili sme si, že budeme zbierať metriky ohľadom funkcionality systému - počet spustení dialógov a metriky ohľadom operačnom systéme a prehliadači používateľov systému, za časový interval 3 sekundy.
Každú metriku (142) trebalo najprv nakonfigurovať.
...
% TODO momentalne chceme gangliu, tak sme testovali zabbix, ze bude zly, aktualne zabbix, metrics, vyuzitie aj dlhodobe 2 v 1? asi ani jedno..., zbieranie metrik
% TODO ciel 18 instalacii porovnavat - Ganglia metrics, gmond gmetric, kniznica, 
% TODO konfiguracia, grafy, ...
% TODO zabbix experimenty datamining
