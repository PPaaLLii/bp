...
\abstrakt{
\noindent Hlavným cieľom našej bakalárskej práce je navrhnúť spôsob monitorovania informačného systému za účelom zbierania užitočných informácií ohľadom výkonu systému a používateľských preferencií. Zaoberáme sa najmä otázkami, aké informácie zbierať a akými nástrojmi ich zbierať. Existuje viacero nástrojov z časti riešiacich našu problematiku. Zameriame sa na open-source nástroje. V\-práci si rozoberieme tie najpoužívanejšie, ich výhody, nevýhody a vybrané nástroje integrujeme do akademického informačného systému AiS2. Pomocou nich sa pokúsime zbierať a zobrazovať metriky, ktoré nám pomôžu identifikovať problémy a funkcie, ktoré je potrebné vylepšiť.
~\\
~\\
