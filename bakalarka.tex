...
Chceme monitorovať tento informačný systém s cieľom identifikovať problémy skôr ako používateľ.
...
Ďalším problémom je to, že vývojári systému AIS2 nie sú správcami systému.
...
Keďže systém AIS beží vo viacerých inštaláciách, 
...
\subsection{Krátkodobé zbieranie metrík}
